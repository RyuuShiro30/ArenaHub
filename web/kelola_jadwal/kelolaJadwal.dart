...
class JadwalModel {
  ...
  static StatusJadwal _parseStatus(String? s) {
    switch (s) {
      case 'tidak_tersedia':
        return StatusJadwal.tidakTersedia;
      case 'dipesan':
        return StatusJadwal.dipesan;
      default:
        return StatusJadwal.tersedia;
    }
  }

  static String statusToString(StatusJadwal s) {
    switch (s) {
      case StatusJadwal.tidakTersedia:
        return 'tidak_tersedia';
      case StatusJadwal.dipesan:
        return 'dipesan';
      default:
        return 'tersedia';
    }
...
class FilterLanjutan {
  ...
  bool get hasFilter =>
      status != FilterStatus.semua || jamMulai != null || jamSelesai != null;
}
...
class _KelolaJadwalScreenState extends State<KelolaJadwalScreen> {
  ...
  Stream<QuerySnapshot> get _jadwalStream {
    Query q =
        FirebaseFirestore.instance.collection('jadwal').orderBy('tanggal');
    ...
    final endOfDay = DateTime(_selectedRange.end.year, _selectedRange.end.month,
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    _filterChip('Semua', FilterStatus.semua, tempStatus,
                        (v) => setInner(() => tempStatus = v)),
                    _filterChip('Tersedia', FilterStatus.tersedia, tempStatus,
                        (v) => setInner(() => tempStatus = v)),
                    _filterChip('Tidak Tersedia', FilterStatus.tidakTersedia,
                        tempStatus, (v) => setInner(() => tempStatus = v)),
                    _filterChip('Dipesan', FilterStatus.dipesan, tempStatus,
                        (v) => setInner(() => tempStatus = v)),
                  ],
                ),
                ...
                Row(children: [
                  Expanded(
                      child: Column(
                        ...
                        _jamDropdown(tempJamMulai, jamOptions,
                            (v) => setInner(() => tempJamMulai = v),
                            hint: 'Semua'),
                      ])),
                      ...
                      child: Column(
                        ...
                        const Text('Sampai jam',
                            style: TextStyle(
                                fontSize: 11.5, color: Color(0xFF9E9E9E))),
                        const SizedBox(height: 4),
                        _jamDropdown(tempJamSelesai, jamOptions,
                            (v) => setInner(() => tempJamSelesai = v),
                            hint: 'Semua'),
                      ])),
                ]),
              ],
  ...
  Widget _filterChip(String label, FilterStatus value, FilterStatus current,
        ...
        child: DropdownButton<String?>(
          ...
          items: options
              .map((t) => DropdownMenuItem(
                    value: t,
                    child:
                        Text(t ?? hint, style: const TextStyle(fontSize: 13)),
                  ))
              .toList(),
          onChanged: onChanged,
        ),
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snap) {
                ...
                final totalTidak = all
                    .where((j) => j.status == StatusJadwal.tidakTersedia)
                    .length;
                final unitLapangan =
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            const Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 6),
                                  Text(
                                      'Atur ketersediaan slot waktu untuk semua unit lapangan secara real-time.',
                                      style: TextStyle(
                                          fontSize: 13.5,
                        ...
                        Row(children: [
                          ...
                          Expanded(
                              child: _statsCard(
                                  ...
                                  label: 'Tersedia',
                                  value:
                                      totalTersedia.toString().padLeft(2, '0'),
                          ...
                          Expanded(
                              child: _statsCard(
                                  ...
                                  value: totalTidak.toString().padLeft(2, '0'),
                          ...
                          Expanded(
                              child: _statsCard(
                                  ...
                                  label: 'Unit Lapangan',
                                  value:
                                      unitLapangan.toString().padLeft(2, '0'),
                      ...
                      // Filter bar — tombol Ekspor Data dihapus
                      Row(children: [
                              ...
                              return _inputBox(
                                ...
                                items: [
                                  const DropdownMenuItem(
                                      value: '', child: Text('Semua Lapangan')),
                                  ...docs.map((d) {
                                    final data =
                                    ...
                                    return DropdownMenuItem(
                                        value: d.id,
                                        child: Text(
                                            data['nama_lapangan'] ?? d.id,
                                            overflow: TextOverflow.ellipsis));
                                  }),
                                ],
                                onChanged: (v) => setState(() {
                                  _selectedLapanganId = v ?? '';
                                  _currentPage = 1;
                                }),
                              )));
                            },
                        ...
                        GestureDetector(
                          ...
                          child: _inputBox(
                              child: Row(
                                ...
                                const SizedBox(width: 8),
                                Text(_fmtRange(_selectedRange),
                                    style: const TextStyle(
                                        fontSize: 13, color: _textDark)),
                              ])),
                        ),
                        const Spacer(),
                        // Tombol Ekspor Data dihapus dari sini
                        Stack(
                          ...
                          children: [
                            ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                  backgroundColor: _filter.hasFilter
                                      ? _primary
                                      : const Color(0xFFEEF2FF),
                                  foregroundColor: _filter.hasFilter
                                      ? Colors.white
                                      : _primary,
                                  elevation: 0,
                                  shape: RoundedRectangleBorder(
                              ...
                              child: Center(
                                ...
                                Text('Belum ada jadwal',
                                    style: TextStyle(
                                        ...
                                        color: Color(0xFF9E9E9E))),
                                SizedBox(height: 4),
                                Text('Tambah jadwal baru dengan tombol di atas',
                                    style: TextStyle(
                                        fontSize: 13,
    ...
    bool isHighlighted = false,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border:
              isHighlighted ? null : Border.all(color: const Color(0xFFE8ECF0)),
          boxShadow: [
            BoxShadow(
        ...
        child: Row(children: [
          Container(
            ...
            height: 44,
            decoration: BoxDecoration(
              color: isHighlighted ? Colors.white.withOpacity(0.2) : iconBg,
              borderRadius: BorderRadius.circular(10),
            ),
            child: Icon(icon,
                size: 22, color: isHighlighted ? Colors.white : iconColor),
          ),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(value,
                style: TextStyle(
                    fontSize: 26,
                    fontWeight: FontWeight.w800,
                    color: isHighlighted ? Colors.white : _textDark)),
          ]),
        ]),
      );
        ...
        child: Row(children: [
          Expanded(
              ...
              child: Row(children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: j.imagePath.isNotEmpty
                      ? Image.network(j.imagePath,
                          width: 44,
                          height: 44,
                          fit: BoxFit.cover,
  ...
  Widget _statusToggle(JadwalModel j) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            color:
                isTersedia ? const Color(0xFFE8F5E9) : const Color(0xFFFBE9E7),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
                color: isTersedia
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          Icon(
            ...
            size: 14,
            color:
                isTersedia ? const Color(0xFF2E7D32) : const Color(0xFFC62828),
          ),
  ...
  Future<void> _confirmDelete(JadwalModel j) async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
            'Hapus jadwal ${j.namaLapangan} (${j.waktuOperasional}) pada ${_fmtTgl(j.tanggal)}?'),
        actions: [
          TextButton(
  ...
  Future<void> _submit() async {
    ...
    if (_isBulkMode && _previewSlots.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Jam buka harus lebih kecil dari jam tutup')));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(_isBulkMode
              ? '${_previewSlots.length} slot berhasil dibuat!'
                            ...
                            builder: (_, snap) {
                              ...
                              return _box(
                                ...
                                onChanged: (v) {
                                  ...
                                  setState(() {
                                    _lapanganId = v;
                                    _namaLapangan = data['nama_lapangan'] ?? '';
                                    _jenisLapangan =
                                        data['jenis_lapangan'] ?? '';
                                    _imagePath =
                                        (data['foto'] as List?)?.isNotEmpty ==
                                                true
                                            ? data['foto'][0]
                                            : '';
                                    _harga = (data['harga'] ?? 0) is int
                                        ? data['harga']
                                        : int.tryParse(
                                                data['harga'].toString()) ??
                                            0;
                              ...
                              Row(children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(20)),
                                  child: Text('${_previewSlots.length} slot',
                                      style: const TextStyle(
                                          fontSize: 11,
                                          fontWeight: FontWeight.w700,
                                          color: Color(0xFF1565C0))),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  ...
                  ElevatedButton(
                    ...
                    child: _isSubmitting
                        ...
                        : Text(
                            _isBulkMode
                                ? 'Generate ${_previewSlots.length} Slot'
                                : 'Simpan Slot',
          ...
          child: Center(
              child: Text(label,
                  style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      color: active ? _primary : const Color(0xFF9E9E9E)))),
        ),
      );
