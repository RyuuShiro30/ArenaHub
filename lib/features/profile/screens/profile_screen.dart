...
final ValueNotifier<String?> profilePhotoNotifier =
    ValueNotifier(null);

final ValueNotifier<String> profileNameNotifier =
    ValueNotifier('');
...
class _ProfileScreenState
  ...
  static const Color _primaryMid =
      Color(0xFF1A4FAF);
