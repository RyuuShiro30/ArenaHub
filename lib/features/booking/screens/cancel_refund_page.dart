...
class _CancelRefundPageState extends State<CancelRefundPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      batch.update(bookingRef, {
        'status':              'dibatalkan', // ← ini yang dicek PilihJadwalPage
      ...
      // 2. Simpan permohonan refund ke collection 'refund_requests'
      final refundRef =
      ...
      batch.set(refundRef, {
        ...
        'status_refund':    'menunggu',   // menunggu → diproses → selesai
      ...
      // Ambil selected_times dari booking lalu cari doc jadwal yang cocok
  ...
  // ── Restore slot: cukup update status booking child jika ada ──
  // PilihJadwalPage cek slot terpakai dari koleksi 'bookings' (status confirmed/pending)
  // Jadi kalau status booking sudah 'dibatalkan', slot otomatis bebas lagi
  // Method ini handle child bookings jika ada (multi-lapangan)
  Future<void> _restoreSlotJadwal() async {
    try {
      // Parent booking sudah diupdate di batch sebelumnya
      // Cek apakah ada child bookings yang perlu diupdate juga
  ...
  Widget _buildInfoBooking() {
    ...
    final jam          = (_booking!['selected_times'] ??
                          _booking!['jam_main'] ?? '-').toString();
      ...
      child: Column(
        ...
        children: [
          ...
          ...[
            ...
            '• Pembatalan H-1 atau kurang dari 24 jam sebelum jadwal dikenakan potongan 50%.',
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color:
                        isSelected ? _primaryColor : const Color(0xFFE2E8F0),
      ...
      child: Row(
        ...
        children: [
          Checkbox(
            ...
            onChanged: (v) =>
                setState(() => _setujuKetentuan = v ?? false),
          ...
          Expanded(
            child: GestureDetector(
              onTap: () =>
                  setState(() => _setujuKetentuan = !_setujuKetentuan),
              child: const Text(
