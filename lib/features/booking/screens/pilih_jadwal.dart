...
// import '../screens/keranjang.dart'; // uncomment dan sesuaikan path saat page keranjang sudah dibuat
...
class _PilihJadwalPageState extends State<PilihJadwalPage>
  ...
  // Animasi FAB keranjang saat item ditambah
  ...
  void initState() {
    ...
    // Setup animasi bounce untuk FAB
  ...
  /// Dipanggil saat user tap slot — tambah/hapus dari keranjang + trigger animasi FAB
  void _toggleSlot(String time) {
    setState(() {
      if (selectedTimes.contains(time)) {
        ...
        // Animasi bounce FAB hanya saat item DITAMBAH
  ...
  /// Kirim data lapangan + selectedTimes agar page keranjang bisa menampilkan detail.
  void _bukaKeranjang() {
    ...
    // TODO: uncomment dan sesuaikan saat halaman keranjang sudah dibuat oleh rekan
    // Navigator.push(
    //   context,
    //   MaterialPageRoute(
              ...
              children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        final picked = await showDatePicker(
                          ...
                          firstDate: DateTime(_nowWib().year, _nowWib().month, _nowWib().day),
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: (isFull || isLoadingSlot) ? null : () => _toggleSlot(time),
                      child: Container(
                        decoration: BoxDecoration(
                ...
                // INFO TOTAL — muncul hanya jika ada slot dipilih
                if (selectedTimes.isNotEmpty) ...[
                  const SizedBox(height: 20),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Icon(Icons.shopping_cart_rounded, color: primaryBlue, size: 18),
  ...
  Widget _placeholderFoto() {
    return Container(
      ...
      child: const Icon(Icons.sports_soccer_rounded, color: Color(0xFF1B4E82), size: 28),
    );
  }
