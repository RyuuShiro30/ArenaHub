      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            /// --- SECTION 2: Data Lokasi ---
            _buildSectionCard(
              icon: Icons.location_on_outlined,
              iconBgColor: accentGreen,
              title: "Data Lokasi",
              body:
                  "Untuk memberikan layanan pemesanan arena yang akurat, aplikasi kami memerlukan akses ke koordinat GPS perangkat Anda. Data ini digunakan secara eksklusif untuk menemukan fasilitas terdekat dan tidak dibagikan kepada pihak ketiga untuk tujuan pemasaran.",
              tags: const [],
            ),
            ...
            _buildUserRight(
              label: "Penghapusan",
              description:
                  "Anda dapat mengajukan permohonan penghapusan akun permanen.",
            ),
            ...
            _buildTermCard(
              ...
              content:
                  "Setiap pengguna hanya diperbolehkan memiliki satu akun aktif. Pembuatan akun ganda dengan identitas yang sama atau berbeda merupakan pelanggaran yang dapat mengakibatkan pemblokiran akun tanpa pemberitahuan.",
            ),
            const SizedBox(height: 12),
            _buildTermCard(
              number: "03",
